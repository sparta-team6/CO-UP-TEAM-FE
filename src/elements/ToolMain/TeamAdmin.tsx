...
const TeamAdmin = ({ profileImage, nickname, aboutMe, url }: User) => {
  return (
    <div className="group w-full mt-[20px] relative flex items-center space-x-2">
      ...
      <div className="left-[-13%] top-[-132px] hidden w-[280px] sm:w-[275px] min-h-[120px] z-50 bg-5 dark:bg-8 border-[#E7EBF2] dark:border-[#666666] border-[1px] border-solid group-hover:flex sm:group-focus:block absolute right-[-315px] rounded-lg shadow-md">
