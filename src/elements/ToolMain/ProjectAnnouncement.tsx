...
const ProjectAnnouncement = () => {
  ...
  return (
    <div className="test5 w-full h-full bg-[#ffffff] dark:bg-7 border-[#D7DCE5] dark:border-[#666666] border-[1px] border-solid rounded-2xl pl-[20px] pr-[10px] sm:px-[20px] flex flex-col">
