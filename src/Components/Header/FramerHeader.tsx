...
const FramerHeader = () => {
  ...
  return (
    <React.Fragment>
      <nav className="sm:hidden w-full h-12 flex justify-between items-center fixed z-50 shadow-md dark:bg-gray-800">
        ...
        <nav className="w-56 h-full flex justify-around items-center sm:hidden dark:bg-gray-800">
