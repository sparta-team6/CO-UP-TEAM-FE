...
const ProjectList = () => {
  ...
  return (
    <div className="w-full h-full bg-[#f0f3f7] flex flex-col items-center justify-center absolute top-0">
      <div className="w-full h-full flex flex-col items-center pt-36 sm:pt-32">
        <div className=" w-[1200px] flex justify-between items-center mb-8 md:w-[90%]">
          <span className="text-4xl leading-[50px] sm:text-3xl">팀 리스트</span>
          <ProjectOpen />
        </div>
        <div className="w-[1200px] flex flex-wrap justify-start  sm:justify-center md:w-[90%]">
          <ProjectData />
